...
class JDDMenu:
    ...
    def __init__(self, menu_options, title="Menu", exit_option_text="Exit", prompt="Select an option: "):
    ...
    def display_menu(self, context=None):
        ...
        while True:
            ...
            print("Enter 0 to" + self.exit_option_text)
            ...
            try:
                ...
                if 0 < choice <= len(self.menu_options):
                    ...
                    action(context)  # Execute the action with context
                else:
                    print(f"Please enter a number between 0 and {len(self.menu_options)}.")
